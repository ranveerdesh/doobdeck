...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center gap-4 border-b border-border/70 bg-background/80 px-4 py-2 backdrop-blur-xl sm:px-6 lg:px-8">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-3 border border-border/70 bg-surface/80 px-2 py-1.5 text-sm text-text-secondary transition-colors hover:border-border hover:bg-surface-raised hover:text-text-primary"
        >
          <div className="flex h-7 w-7 items-center justify-center border border-border/70 bg-accent text-xs font-semibold text-accent-foreground">
